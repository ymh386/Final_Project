                    ...
                    <div class="container">
							<!-- contents -->
								<ul class="nav nav-tabs">
									...
									<li class="nav-item">
										<a class="nav-link active" href="./requestList">보낸 요청</a>
									</li>									
									<li class="nav-item">
								...
								<c:forEach var="l" items="${list}">
									<form action="/friend/requestList" method="post">
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center justify-content-between py-3">
											...
											<img src="/img/default.png" 
												...
												alt="avatar">
											<div>
												<div class="fw-bold">${l.receiverId}</div>
												<input hidden name="receiverId" value="${l.receiverId}">
											</div>
											</div>
											<div class="text-end">
