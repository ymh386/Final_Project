...
<head>
    ...
    <style>
        body { background: #f6f7fb; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        h2 { margin-bottom: 28px; letter-spacing: -1px; }
        ...
        th, td { padding: 13px 7px; text-align: center; border-bottom: 1px solid #e0e3ef; }
        th { background: #f5f7fa; color: #2c387e; }
        tr:hover { background: #f9fafc; }
        .title-col { text-align: left; }
        .paging { margin: 22px 0 0 0; text-align: center; }
        .paging a { margin: 0 3px; color: #555; text-decoration: none; }
        .paging .cur { font-weight: bold; color: #2025b6; }
    </style>
</head>
<body>
<div class="container">
