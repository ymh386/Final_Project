        ...
        <div class="card login-card shadow-sm">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs mb-3 justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link" href="/user/login/login">일반회원</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="/user/login/trainerLogin">트레이너</a>
                    </li>
                </ul>
                ...
                <div class="text-center mt-4">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="/oauth2/authorization/kakao?redirect=trainer">
                            <img src="/img/kakao.png" alt="카카오 로그인" />
                        </a>
                        <a href="/oauth2/authorization/google?redirect=trainer">
